  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v2 - Your one-stop platform for easy and efficient rental of construction tools from a network of trusted suppliers."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v2 - Your one-stop platform for easy and efficient rental of construction tools from a network of trusted suppliers.`}
            </Text>
            <Box
